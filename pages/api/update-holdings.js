...
export default async function handler(req, res) {
  ...
  try {
    // 读取当前持仓
    const getReq = await fetch('https://api.github.com/repos/ponylin06/daily-recap/contents/data/_holdings.json', { headers: A })
    ...
    await fetch('https://api.github.com/repos/ponylin06/daily-recap/contents/data/_holdings.json', {
